...
<small>Start where you are. Use what you have. Do what you can.</small>
		...
		<span>
			<input id="gender" name="gender" class="element radio" type="radio" value="male" />
...
<label class="choice" for="element_7_3">Other</label>
		...
		<div>
			<input id="element_4_1" name="addr1" class="element text large" value="" type="text">
...
<tr><td><b>Message:</b></td><td>'.$_POST['aoif'].'</td></tr>
